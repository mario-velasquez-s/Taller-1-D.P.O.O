...
public class ConsolaOlimpicos
{
	...
	/*
	 * Le muestra al usuario la nacionalidad de un atleta dado
	 */
	
	private void ejecutarNacionalidadAtleta()
	{
		System.out.println("\n" + "Nacionalidad de un atleta" + "\n");
		String nombre = input("Por favor ingrese el nombre del atleta de interés: ");
		String pais = calculadora.nacionalidadAtleta(nombre);
		System.out.println("\n" + "El atleta llamado " + nombre + " representa al pais de " + pais + "\n");
	}
